...
import {fileExists, getMessage, validateMessage, showError, realPath} from './helpers'
  ...
  handleConnection(path, connection) {
    ...
    connection.onMessage('compile:error', message => {
      ...
      if (!validateMessage(error)) {
        showError('Invalid Error Message received from compiler', 'Check your console for more information')
        console.error('[Flint] Invalid error message from compiler', {message})
        return
      }
